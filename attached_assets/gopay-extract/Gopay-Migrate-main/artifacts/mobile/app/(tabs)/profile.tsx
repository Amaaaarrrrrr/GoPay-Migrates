...
const styles = StyleSheet.create({
  ...
  userCard: {
    ...
    backgroundColor: C.card, borderRadius: RADIUS['2xl'], padding: 20,
  ...
  menuItem: {
    flexDirection: 'row', alignItems: 'center', gap: 14,
    backgroundColor: C.card, borderRadius: RADIUS.xl, padding: 16,
  ...
  signOutBtn: {
    ...
    backgroundColor: C.destructiveBg, borderWidth: 1, borderColor: `${C.destructive}33`,
